        ...
        >
            ...
            <div className="flex pb-56">
                ...
                <div className="mx-16">
                    ...
                    <div className="card w-fit gradient-base shadow-xl">
                        <div className="card-body">
                            <div className="card-actions items-center">
                                ...
                                <div className="mr-16">
                                    <p className="font-bold text-lg -mb-2">30 Soal </p>
                                ...
                                <div className="">
                                    <p className="font-bold text-lg -mb-2">1 Jam </p>
                                    <p className="font-light text-slate-500">10:00 - & 11-00 WIB </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="mt-6 card w-fit gradient-base shadow-xl">
                        <div className="card-body">
                            <div className="card-actions items-center">
                                <strong className="mr-24">Soal Materi 1</strong>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
