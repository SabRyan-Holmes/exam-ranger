...
export default function AdminPageSoalTipe({ title, exams, auth, answeredSubject }) {
                                    ...
                                    <div className="mb-2  card w-fit shadow-md hover:bg-primary/30 ">
                                        <div className="m-6 rounded-md   ">
                                            <div className="card-actions  items-center ">
                                                ...
                                                <div className="mr-4">
                                                    <p className="font-bold text-lg -mb-2">{data.answer.length} Soal </p>
                                                ...
                                                <div className="">
                                                    <p className="font-bold text-lg -mb-1">120 Menit </p>
