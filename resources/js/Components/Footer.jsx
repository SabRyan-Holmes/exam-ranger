                ...
                <div className="flex  flex-wrap justify-center items-center mx-auto  ">
                    ...
                    <div className="md:place-self-center md:justify-self-end ml-7 pt-5">
                        <div className="grid grid-flow-col gap-6">
                            ...
                            <a href="https://www.instagram.com/anatomifkunja?igsh=eW93M2M4dzc5MzIy" className='scale-125 hover:scale-150 hover:fill-secondary  stroke-emerald-700 hover:stroke-secondary'>
